      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h2 className="text-2xl font-bold text-accent mb-4">RENEW</h2>
            <p className="text-gray-300 mb-4">
              Professional hair loss solutions backed by science. Our certified trichologist
              provides personalized treatments to help you restore confidence.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/alma-ted" className="hover:text-accent transition">Alma TED</Link></li>
              <li><Link href="/about" className="hover:text-accent transition">About Us</Link></li>
              <li><Link href="/faqs" className="hover:text-accent transition">FAQs</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              <li>
                <a href="tel:801-899-9183" className="hover:text-accent transition">
                  (801) 899-9183
                </a>
              </li>
              <li>
                <a href="mailto:support@renewhairlosscenter.com" className="hover:text-accent transition">
        ...
        <div className="border-t border-gray-600 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-400 text-sm">
            &copy; {new Date().getFullYear()} Renew Hair Loss Center. All rights reserved.
          </p>
